...
public class TileEntityDrawersUnlimited extends TileEntityDrawersStandard {
	...
	public static class Legacy extends TileEntityDrawersUnlimited {
		...
		public void replaceWithCurrent() {
			TileEntityDrawersUnlimited replacement = createEntity(groupData.getDrawerCount());
			if(replacement != null) {
	...
	public static TileEntityDrawersUnlimited createEntity(int slotCount) {
		switch(slotCount) {
		case 1:
			return new Slot1();
		case 2:
	...
	private class GroupData extends StandardDrawerGroup {
		...
		public boolean hasCapability(@Nonnull Capability<?> capability, @Nullable EnumFacing facing) {
			return capability == TileEntityDrawersUnlimited.DRAWER_ATTRIBUTES_CAPABILITY
		...
		public <T> T getCapability(@Nonnull Capability<T> capability, @Nullable EnumFacing facing) {
			if(capability == TileEntityDrawersUnlimited.DRAWER_ATTRIBUTES_CAPABILITY)
				return (T)TileEntityDrawersUnlimited.this.getDrawerAttributes();
